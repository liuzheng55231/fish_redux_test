...
itemDetailBeanEntityFromJson(ItemDetailBeanEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new ItemDetailBeanData().fromJson(json['data']);
	}
...
Map<String, dynamic> itemDetailBeanEntityToJson(ItemDetailBeanEntity entity) {
...
itemDetailBeanDataFromJson(ItemDetailBeanData data, Map<String, dynamic> json) {
	if (json['curPage'] != null) {
		data.curPage = json['curPage']?.toInt();
	}
	if (json['datas'] != null) {
		data.datas = new List<ItemDetailBeanDataData>();
		(json['datas'] as List).forEach((v) {
			data.datas.add(new ItemDetailBeanDataData().fromJson(v));
		});
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> itemDetailBeanDataToJson(ItemDetailBeanData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
itemDetailBeanDataDataFromJson(ItemDetailBeanDataData data, Map<String, dynamic> json) {
	...
	if (json['tags'] != null) {
		data.tags = new List<ItemDetailBeanDataDatasTag>();
		(json['tags'] as List).forEach((v) {
			data.tags.add(new ItemDetailBeanDataDatasTag().fromJson(v));
		});
	}
	if (json['title'] != null) {
...
Map<String, dynamic> itemDetailBeanDataDataToJson(ItemDetailBeanDataData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
itemDetailBeanDataDatasTagFromJson(ItemDetailBeanDataDatasTag data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> itemDetailBeanDataDatasTagToJson(ItemDetailBeanDataDatasTag entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
